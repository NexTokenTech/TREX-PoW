//! Generic implementation of a capsule block header.
...
use sp_runtime::traits::{self, AtLeast32BitUnsigned, Hash as HashT, MaybeDisplay, MaybeMallocSizeOf, MaybeSerialize,
    ...
    fn ensure_format_is_unchanged() {
        let header = Header::<u32, BlakeTwo256> {
            ...
            digest: sp_runtime::generic::Digest {
                logs: vec![sp_runtime::generic::DigestItem::Other(b"6".to_vec())],
            },
        };
        ...
        let header = Header::<u32, BlakeTwo256> {
            ...
            digest: sp_runtime::generic::Digest {
                logs: vec![sp_runtime::generic::DigestItem::Other(b"5000".to_vec())],
            },
        };
